			...
			<div class="container">
				<div class="header-left">
					<div class="w3layouts-logo">
						<h1>
							<a href="#">AGRICULTURE<span></span></a>
						</h1>
					</div>
				</div>
					...
					<div class="top-nav">
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								...
								<li><a class="active" href="Farmerhome.php">Home</a></li>
									<li><a href="Uploaddatas.php">Upload Datas</a></li>
<li><a href="Viewupload.php">Uploaddetails</a></li>
									<li><a href="ViewfarmerOrders.php">Orders</a></li>
